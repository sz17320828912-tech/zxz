...
if __name__ == "__main__":
    ...
    print("traub suze",tr)
    ftrainval   = open(os.path.join(saveBasePath,'trainval2.txt'), 'w')
    ftest       = open(os.path.join(saveBasePath,'test2.txt'), 'w')
    ftrain      = open(os.path.join(saveBasePath,'train2.txt'), 'w')
    fval        = open(os.path.join(saveBasePath,'val2.txt'), 'w')
    ...
    print("Images中的图片应当为.jpg文件、SegmentationClass中的图片应当为.png文件。")
    print("如果格式有误，参考:")
